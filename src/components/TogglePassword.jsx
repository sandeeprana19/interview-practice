...
// Always show the placeholder text when empty. By default:
...
// Toggle the visibility of the password between masked and unmasked. Instantly update both:
// The icon (Eye + EyeOff).
...
// • data-testid="visibility-label": Text label showing whether password is
// visible or hidden
